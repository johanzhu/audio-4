...
/******/ 	var hotCurrentHash = "f7243ba9ad501a7ae9b7"; // eslint-disable-line no-unused-vars
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ball__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__OrbitControls__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__OrbitControls___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__OrbitControls__);
...
function createStage() {
	...
	ball = new __WEBPACK_IMPORTED_MODULE_2__ball__["a" /* default */](null,null,imgs,camera);
...
function Ball(geo,mat,imgs,camera) {
	...
	var fragmentShader = [
		...
		"void main() {",
			"gl_FragColor = textureCube(mapCube, reflect(normalize(-cameraPosition), normalize(vNormal)));",
	...
	this.material = new THREE.ShaderMaterial({
		uniforms : {
			mapCube: { type:"t", value: new THREE.CubeTexture(imgs) },
